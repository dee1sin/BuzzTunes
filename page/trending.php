<h3 style="padding-left: 10px;"><a href="/trending">Trending</a></h3>
<?php
...
<div>
    <ul class="hl" style="float:right;">
        ...
        <li><a href="/trending/<?php echo $PAGE_NUMBER-1;?>" class="pagingButton">Previous</a></li>
        <?php } ?>
        <?php if ($PAGE_NUMBER*$MUSIC_PER_PAGE < $TOTAL_COUNT) { ?>
        <li><a href="/trending/<?php echo $PAGE_NUMBER+1;?>" class="pagingButton">Next</a></li>
        <?php } ?>
    </ul>
</div>
<div class="clearFix"></div>
